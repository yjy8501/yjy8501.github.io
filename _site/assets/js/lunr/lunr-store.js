var store = [{
        ...
        "excerpt":"1. 배운점 1.1 컴퓨터와 프로그래밍이란? 우리는 컴퓨터를 흔히 만능 머신이라고 생각한다. 하지만 우리가 사용하는 많은 기능들은 프로그래머들이 컴퓨터가 이해할 수 있게 프로그래밍 언어를 사용하여 컴퓨터가 해야 할 행동들을 설정해놓은 것들이다. 그렇기 때문에 컴퓨터 입장에서 생각하며 프로그래밍을 하는 연습을 해야한다. 1.2 웹 서버와 클라이언트 간단하게 말하자면 클라이언트는 리소스를 사용하는 곳, 서버는...","categories": ["Memoir"],
        "tags": ["Codestates"],
        "url": "/memoir/SEB_BE2/",
        "teaser": null
      }]
